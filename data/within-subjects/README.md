...
**Dataset title:** Clean data from within-subjects pilot study for project on 
...
- `likely_AI` - numeric, 1-7 Likert scale, response to the question "How 
likely do you think [advisor] is to be AI?" from Not at All Likely (1) to Very
Likely (7)
